import argparse
from denoisenet_full import ME_denoise_net_tcm1, DB_denoise_net_tcm1, CP_denoise_net_tcm1
from train_vb import main
...
# select GPU device
train_model = DB_denoise_net_tcm1(X=X, R= R_sub, is_gate= is_gate)
